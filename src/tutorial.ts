...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    body: "Classic LLM with 3 tools to interact with Jev: set_jev_state (writes Jev's state), set_jev_questions (writes Jev's questions), ask_jev (asks Jev to answer the questions).",
    page: "workshop",
    hooks: ["llm"],
    selectors: [".pane.llm"],
  },
